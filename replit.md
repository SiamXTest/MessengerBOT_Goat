# Siam Bhau Bot - Facebook Messenger Bot

## Overview

Siam Bhau Bot is a Facebook Messenger chatbot framework built on Node.js that enables automated interactions through Facebook's messaging platform. The bot provides a plugin-based command system, user/thread data management, role-based permissions, and a web dashboard for configuration.

**Owner Info:**
- Bot Name: Siam Bhau
- Author: Siam Bhau
- Facebook: https://facebook.com/SiamBhau69
